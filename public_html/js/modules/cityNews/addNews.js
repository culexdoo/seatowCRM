...
$(document).ready(function() {
	...
	// Decide wether from scratch or errored from adding city
	if (centerLatitude == '' && centerLongitude == '') {
		...
		$('#center_latitude').val(centerLatitude);
		$('#center_longitude').val(centerLongitude);
	...
	// Reset city settings on change city (city company change)
