/*
*	CityHub - Tourist information - Add entry
*/
...
// Set city
function setCity(city_name, city_latitude, city_longitude, city_coordinates) {
...
$(document).ready(function() {
	...
	setCity(cities[$('#city_id').val()].name, cities[$('#city_id').val()].latitude, cities[$('#city_id').val()].longitude, cities[$('#city_id').val()].coordinates);
	...
	$('#city_id').change(function(){
		var thisID = $(this).val();
		setCity(cities[thisID].name, cities[thisID].latitude, cities[thisID].longitude, cities[thisID].coordinates);
	});
	...
	// Decide wether from scratch or errored from adding entry
	if (!(entryLatitude == '' && entryLongitude == '')) {

		// Set the displays of coordinates
		$('#center_latitude').val(entryLatitude);
		$('#center_longitude').val(entryLongitude);



		// Make the marker
		entryMarker = new google.maps.Marker({
			position: new google.maps.LatLng(entryLatitude, entryLongitude),
			map: map,
			draggable: true
		});
