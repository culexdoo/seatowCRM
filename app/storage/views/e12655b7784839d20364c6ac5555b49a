            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
               ...
               <tr>
                    ...
                    <td class="mailbox-subject"><b>2 Woman lost in sea.</b> - Trying to find a solution to this problem...
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    <td class="mailbox-name"><a href="read-mail.html">Alexander Pierce</a></td>
                    <td class="mailbox-subject"><b>The dogs are crazy</b> - I have cats...
                    </td>
                    <td class="mailbox-attachment"></td>
                    ...
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    <td class="mailbox-name"><a href="read-mail.html">Alexander Pierce</a></td>
                    <td class="mailbox-subject"><b>Broken engine</b> - Bought new one...
                    </td>
                    <td class="mailbox-attachment"></td>
                    ...
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    <td class="mailbox-name"><a href="read-mail.html">Alexander Pierce</a></td>
                    <td class="mailbox-subject"><b>Call me</b> - I have no phone in my hands.
                    </td>
                    <td class="mailbox-attachment"></td>
                    <td class="mailbox-date">2 days ago</td>
                  </tr>
