   	  ...
   	  <div class="container">
	   	    <div class="content_middle_box">
	   	    	...
	   	    	<div class="row">
	   	    		...
	   	    		<div class="col-lg-12 ponuda-proizvoda" style="margin: 50px 0 50px 0;">
		   	    		<h3 class="text-center">Ponuda proizvoda</h3>
	   	    		</div>
				...
				<div class="top_grid offers">
	   	    	...
	   	    	<div class="row">
	   	    		...
	   	    		<div class="col-lg-12 ponuda-proizvoda" style="margin: 50px 0 50px 0;">
		   	    		<h3 class="text-center">Potražnja za proizvodima</h3>
	   	    		</div>

	   	    	</div>


	          	<div class="top_grid demands">
	           	 @if (count($classifiedsdemands['entries']) > 0)  
		                ...
		                <div class="col-xs-12">
		                  <div class="box"> 
		                    <div class="box-body">
		                    	<div class="col-lg-9">
		                    		<h3>Nije zatražen niti jedan proizvod.</h3>
	    						</div> 
		                    </div>
		                  </div>
		                </div>
