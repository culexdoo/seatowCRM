	   	    		...
	   	    		<div class="col-lg-4">
	   	    			...
	   	    			<div class="single_img">
		                  	 @if ($entry->image != '' || $entry->image != null)
                     			 <img src="{{ url('/') }}/uploads/modules/classifieddemand/{{ $entry->image }}" class="img-responsive">
                      		@endif  
                     	</div>
	   	    		</div>
			   	    		 	...
			   	    		 	<div class="row mt20">
			   	    		 		...
			   	    		 		<div class="col-md-8">
				                          ...
				                          <h5>{{ $singlecategory->category_name }}</h5>
				                   		  <a href="{{ URL::route('getDemandCategoryEntries', array('id' => $singlecategory->category_id)) }}" class="btn btn-success btn-flat"><i class="fa fa-eye"></i>    Pogledaj ponude iz kategorije</a>
			   	    		 		</div>
			   	    		 	</div>
			   	    		@endforeach
	   	    		 @endif
				   			  ...
				   			  <div class="grid1">
				                   ...
				                   <i class="home"></i>
				   				 <div class="inner_wrap">
				   				 	...
				   				 	<ul class="star1">
				   				 	  <h4 class="green"><a href="{{ URL::route('getDemandCategoryEntries', array('id' => $classifiedsdemand->category_id)) }}">{{ $classifiedsdemand->category_name }}</a></h4> 
