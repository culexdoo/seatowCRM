          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="{{ URL::route('InboxMessages') }}"><i class="fa fa-inbox"></i>{{ Lang::get('messages_msg.inbox') }}
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table id="messagesTable" class="table">
                  ...
                  <tr @if ($message->is_read == '0')class="unread" @endif>
                  <td>@if ($message->is_read == '0')<b>Unread</b> @else Read @endif</td>
